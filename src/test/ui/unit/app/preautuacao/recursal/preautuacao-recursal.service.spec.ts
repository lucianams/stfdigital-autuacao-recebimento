...
describe("Teste do serviço de preautuação recursal", () => {
    ...
    beforeEach(inject(['$httpBackend', 'app.recebimento.preautuacao-recursal.PreautuacaoRecursalService', 'properties', (_$httpBackend_ : ng.IHttpBackendService, _preautuacaoRecursalService_ : PreautuacaoRecursalService, _properties_) => {
    ...
    it("deveria chamar o serviço rest de preautuação recursal", () => {
    	...
    	cmdPreautuar.sigilo = '';
        $httpBackend.expectPOST(properties.apiUrl + '/recebimento/api/remessas/preautuacao-recursal', cmdPreautuar).respond(200,"");
