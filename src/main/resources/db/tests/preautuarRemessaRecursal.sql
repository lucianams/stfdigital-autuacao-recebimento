...
('-114', 1, '-114', 'RE:9007', NULL, @proc_def_id_, NULL, 'preautuacao', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);    
...
('-122', 1, '-114', '-114', @proc_def_id_, STRINGDECODE('Pr\u00e9-Autuar Remessa de Processo Recursal'), NULL, 'PREAUTUACAO', 'preautuacao', NULL, NULL, NULL, 50, TIMESTAMP '2016-05-31 17:42:26.038', NULL, NULL, 1, NULL, NULL);            
...
('-121', @proc_def_id_, '-114', '-114', 'preautuacao', '-122', NULL, STRINGDECODE('Pr\u00e9-Autuar Remessa de Processo Recursal'), 'userTask', NULL, TIMESTAMP '2016-05-31 17:42:26.038', NULL, NULL, NULL);    
...
('-122', @proc_def_id_, 'preautuacao', '-114', '-114', STRINGDECODE('Pr\u00e9-Autuar Remessa de Processo Recursal'), NULL, 'PREAUTUACAO', NULL, NULL, TIMESTAMP '2016-05-31 17:42:26.038', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);    
