...
import {PeticaoFisicaService, PeticaoFisicaCommand, FormaRecebimento} from
        "recebimento/peticoes-fisicas/peticao-fisica.service";
...
describe("Teste do controlador peticao-fisica.controller", () => {
    ...
    beforeEach(() => {
        ...
        controller = new PeticaoFisicaController(mockState, mockPeticaoFisicaService,
                [new FormaRecebimento("MALOTE", "Malote", false)], mockMessagesService, [{
                    nome: "PUBLICO",
                    descricao: "Público"
                }, {
