...
('-24', 1, '-24', 'RE:9001', NULL, @proc_def_id_, NULL, 'preautuar-originario', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);              
...
('-32', 1, '-24', '-24', @proc_def_id_, STRINGDECODE('Pr\u00e9-Autuar Remessa de Processo Origin\u00e1rio'), NULL, 'PREAUTUACAO', 'preautuar-originario', NULL, NULL, NULL, 50, TIMESTAMP '2016-05-31 17:42:37.772', NULL, NULL, 1, NULL, NULL);       

INSERT INTO PUBLIC.ACT_RU_IDENTITYLINK(ID_, REV_, GROUP_ID_, TYPE_, USER_ID_, TASK_ID_, PROC_INST_ID_, PROC_DEF_ID_) VALUES
('-33', 1, 'preautuador-originario', 'candidate', NULL, '-32', NULL, NULL);     
...
('-24', '-24', 'RE:9001', @proc_def_id_, TIMESTAMP '2016-05-31 17:42:37.771', NULL, NULL, NULL, 'inicio', NULL, NULL, NULL, NULL, NULL);          
...
('-25', @proc_def_id_, '-24', '-24', 'inicio', NULL, NULL, NULL, 'startEvent', NULL, TIMESTAMP '2016-05-31 17:42:37.771', TIMESTAMP '2016-05-31 17:42:37.772', 1, NULL),
('-30', @proc_def_id_, '-24', '-24', 'preautuacao-transicoes', NULL, NULL, NULL, 'exclusiveGateway', NULL, TIMESTAMP '2016-05-31 17:42:37.772', TIMESTAMP '2016-05-31 17:42:37.772', 0, NULL),
('-31', @proc_def_id_, '-24', '-24', 'preautuar-originario', '-32', NULL, STRINGDECODE('Pr\u00e9-Autuar Remessa de Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-05-31 17:42:37.772', NULL, NULL, NULL);            
...
('-32', @proc_def_id_, 'preautuar-originario', '-24', '-24', STRINGDECODE('Pr\u00e9-Autuar Remessa de Processo Origin\u00e1rio'), NULL, 'PREAUTUACAO', NULL, NULL, TIMESTAMP '2016-05-31 17:42:37.772', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);   
...
('-33', 'preautuador-originario', 'candidate', NULL, '-32', NULL);    