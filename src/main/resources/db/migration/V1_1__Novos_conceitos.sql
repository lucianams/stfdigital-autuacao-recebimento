create table recebimento.classe_peticionavel (sig_classe varchar2(6) not null, nom_classe varchar2(80) not null, constraint pk_classe_peticionavel primary key (sig_classe));
...
create table recebimento.devolucao (seq_protocolo number not null, dsc_motivacao varchar2(250) not null, seq_motivo_devolucao number, seq_modelo_documento number, seq_texto number, constraint pk_devolucao primary key (seq_protocolo));
