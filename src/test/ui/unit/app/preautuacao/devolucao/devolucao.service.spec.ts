...
describe("Teste do serviço de devolução na preautuação", () => {
    ...
    beforeEach(inject(['$httpBackend', 'app.recebimento.preautuacao-devolucao.DevolucaoService', 'properties', (_$httpBackend_ : ng.IHttpBackendService, _devolucaoService_ : DevolucaoService, _properties_) => {
