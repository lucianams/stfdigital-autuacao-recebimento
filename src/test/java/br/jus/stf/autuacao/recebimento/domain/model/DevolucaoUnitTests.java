...
public class DevolucaoUnitTests {
    ...
    public void iniciaDevolucao() {
        ...
        assertEquals("Identidade da remessa e da devolução devem ser iguais.", remessa.identity(),
                remessa.devolucao().remessa());
    ...
    public void elaboraOficioDevolucao() {
        ...
        assertEquals("Descrição do motivo deve ser igual a Faltam Peças.", motivo.descricao(),
                remessa.devolucao().motivo().descricao());
