...
create table recebimento.devolucao (seq_protocolo number not null, dsc_motivo varchar2(1000) not null, seq_motivo_devolucao number, seq_modelo_documento number, seq_texto number, constraint pk_devolucao primary key (seq_protocolo));
