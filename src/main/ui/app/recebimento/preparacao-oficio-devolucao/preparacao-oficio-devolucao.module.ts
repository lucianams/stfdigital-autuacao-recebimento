...
function config($stateProvider: ng.ui.IStateProvider, properties: app.support.constants.Properties) {
    ...
    $stateProvider.state('app.tarefas.recebimento-preparacao-oficio-devolucao', {
        ...
        resolve : {
            motivosDevolucao : ['app.recebimento.preparacao-oficio-devolucao.PreparacaoOficioDevolucaoService', (preparacaoOficioDevolucaoService: PreparacaoOficioDevolucaoService) => {
...
let preparacaoOficioDevolucao: ng.IModule = angular.module('app.recebimento.preparacao-oficio-devolucao', ['app.recebimento.services', 'app.novo-processo', 'app.support', 'app.support']);
