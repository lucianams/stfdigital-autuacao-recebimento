...
('-24', 1, '-24', 'RE:9001', NULL, 'recebimento:1:3', NULL, 'preautuacao-originario', TRUE, FALSE, TRUE, FALSE, 1, 2, NULL, NULL, NULL);              
...
('-32', 1, '-24', '-24', 'recebimento:1:3', STRINGDECODE('Pr\u00e9-Autuar Remessa de Processo Origin\u00e1rio'), NULL, 'PREAUTUACAO', 'preautuacao-originario', NULL, NULL, NULL, 50, TIMESTAMP '2016-05-31 17:42:37.772', NULL, NULL, 1, NULL, NULL);       
...
('-31', 'recebimento:1:3', '-24', '-24', 'preautuacao-originario', '-32', NULL, STRINGDECODE('Pr\u00e9-Autuar Remessa de Processo Origin\u00e1rio'), 'userTask', NULL, TIMESTAMP '2016-05-31 17:42:37.772', NULL, NULL, NULL);            
...
('-32', 'recebimento:1:3', 'preautuacao-originario', '-24', '-24', STRINGDECODE('Pr\u00e9-Autuar Remessa de Processo Origin\u00e1rio'), NULL, 'PREAUTUACAO', NULL, NULL, TIMESTAMP '2016-05-31 17:42:37.772', NULL, NULL, NULL, NULL, 50, NULL, NULL, NULL, NULL);   
