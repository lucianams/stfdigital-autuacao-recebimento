import {DevolucaoAssinaturaService, AssinarOficioParaDevolucaoCommand, Devolucao, Documento} from "recebimento/devolucao-assinatura/devolucao-assinatura.service";
...
describe('Teste do serviço devolucao-assinatura.service', () => {
	...
	beforeEach(inject(['$httpBackend', 'app.recebimento.devolucao-assinatura.DevolucaoAssinaturaService', 'properties', (_$httpBackend_ : ng.IHttpBackendService, _devolucaoAssinaturaService_ : DevolucaoAssinaturaService, _properties_: app.support.constants.Properties) => {
   ...
   it("Deveria chamar o serviço rest de assinar o ofício de devolução", () => {
        ...
        $httpBackend.expectPOST(properties.apiUrl + '/recebimento/api/remessas/devolucao-assinatura', command).respond(200, {});
    ...
    it("Deveria chamar o serviço rest de consultar devoluções", () => {
		let protocolos = [1, 2];
		let devolucao1 = <Devolucao>{textoId: 1, remessaProtocoloId: 1, remessaNumero: 1, remessaAno: 2016,
						modeloDevolucao: <Modelo>{id: 7, documento: 16, nome: 'Modelo 1', tipoDocumento: new TipoDocumento(3, 'Ofício de devolução 1')}};
		let devolucao2 = <Devolucao>{textoId: 2, remessaProtocoloId: 2, remessaNumero: 2, remessaAno: 2016,
						modeloDevolucao: <Modelo>{id: 8, documento: 17, nome: 'Modelo 2', tipoDocumento: new TipoDocumento(4, 'Ofício de devolução 2')}}
   ...
   it("Deveria chamar o serviço rest de consultar o documento final do texto", () => {
		...
		let documento: Documento = <Documento>{documentoId: 4, quantidadePaginas: 12, tamanho: 1024};
